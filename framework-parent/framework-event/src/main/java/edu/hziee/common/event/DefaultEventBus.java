...
public class DefaultEventBus implements EventBus {
   ...
   * (non-Javadoc)
   * 
   * @see edu.hziee.common.event.EventBus#subscribe(java.lang.String,
   * edu.hziee.common.lang.Closure)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see edu.hziee.common.event.EventBus#unsubscribe(java.lang.String,
   * edu.hziee.common.lang.Closure)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see edu.hziee.common.event.EventBus#publish(java.lang.String,
   * java.lang.Object[])
   */
  @Override
